        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form 
                        method="POST" 
                        action="{{ route('commandes.update', $commande->id) }}"
                    ...
                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input name="nom" type="text" class="form-control" value="{{ $commande->nom }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="prenom" class="form-control" value="{{ $commande->prenom }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="tel" class="form-control" value="{{ $commande->tel }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="region" class="form-control" value="{{ $commande->region }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="ville" class="form-control" value="{{ $commande->ville }}">
                            </div>
                        </div>
